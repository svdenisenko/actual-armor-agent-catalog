...
|---|---|---|---|---|---|---|
| Corporate Reputation Analyst | Strategic Intelligence / Corporate & Executive Risk | full_spec_draft (reference package present) | public_full | marketplace_draft_created / runtime_smoke_passed_with_notes / not_public_ready / needs_final_product_review | not_promotion_ready | https://github.com/svdenisenko/actual-armor-agent-catalog/tree/main/agents/osint-socmint-intelligence/corporate-reputation-analyst |
